 ...
 * const autofillConfig  = { featureName: "Autofill" };
 * const debugConfig     = { featureName: "Debugging" };
 *
 * const autofillMessaging = fromConfig(new WindowsMessagingConfig(autofill.featureName));
 * const debugMessaging    = fromConfig(new WindowsMessagingConfig(debugConfig.featureName));
 *
