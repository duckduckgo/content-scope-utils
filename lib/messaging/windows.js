...
export class WindowsMessagingTransport {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  notify(name, data = {}) {
    windowsTransport(this.config.featureName, name, data, {})
  }
  /**
   * @param {string} name
   * @param {Record<string, any>} [data]
  ...
  request(name, data = {}, opts = {}) {
    return windowsTransport(this.config.featureName, name, data, opts).withResponse(name + 'Response')
  }
}
 ...
 */
function windowsTransport(feature, name, data, options) {
